################################################################
# Author : OSᗩᗰᗩ-ZᗩᗰZᗩᗰ
# GitHub : https://github.com/aqa1982
# Coder  : LIBYA-1982
...
def logo():
    os.system("clear")
    logopsb(
        "\033[92m  ____          _____     _              \n / ___| ___ _ _|_   _|__ | | _____ _ __  \n| |  _ / _ \ '_ \| |/ _ \| |/ / _ \ '_ \ \n| |_| |  __/ | | | | (_) |   <  __/ | | |\n \____|\___|_| |_|_|\___/|_|\_\___|_| |_|\n                                         ")
    logopsb("\033[3;90m			A Product Of OSᗩᗰᗩ-ZᗩᗰZᗩᗰ\033[0;92m")
    time.sleep(0.6)
    logopsb(
        "\033[34m\n|****************************************************|\n|\033[3m Author   : OSᗩᗰᗩ-ZᗩᗰZᗩᗰ                              \033[0;34m|\n|\033[3m Tool     : Facebook Token and cookis Generator                \033[0;34m|\n|\033[3m Version  : 1.0                                     \033[0;34m|\n|\033[3m Link     : https://www.github.com/aqa1982	     \033[0;34m|\n|\033[3m Coded By : LIBYA-1982     		     	     \033[0;34m|\n******************************************************")
    time.sleep(0.8)
...
def logout():
    ...
    psb("\n\t[ https://www.facebook.com/profile.php?id=100024557781911 ]\n")
    sys.exit()
...
def email_login():
    ...
    try:
        ...
        ses.post("https://m.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100", headers=head2,
                 data=payload)
